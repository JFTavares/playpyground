...
class Game(tk.Frame):
    ...
    def create_widgets(self):
        ...
        instr_input = [
            ('Atrás de uma porta está o DINHEIRO!', 1, 0, 5, 'W'),
            ('Atrás das outras:  BODES!!!', 2, 0, 5, 'W'),
            ('Escolha uma porta:', 1, 3, 1, 'E')
            ]
        ...
        instr_lbl = tk.Label(self.parent, text='Trocar de porta?')
        instr_lbl.grid(row=2, column=3, columnspan=1, sticky='E')

        self.yes = tk.Radiobutton(self.parent, state='disabled', text='S',
...
root = tk.Tk()
root.title('O paradoxo Monty Hall')
